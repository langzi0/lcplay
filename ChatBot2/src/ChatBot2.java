...
public class ChatBot2
{
  ...
  public String getResponse(String statement)
  {
    ...
    else if (findKeyword(statement, "I feel that", 0) >= 0)
    {
      response = transformYoutuberStatement(statement);
    }
  ...
  private String transformYoutuberStatement(String statement)
  {
    statement = statement.trim();
    String lastChar = statement.substring(statement.length() - 1);
    if (lastChar.equals("."))
    ...
    int psnOf1 = findKeyword(statement, "I feel that", 0);
    int psnOf2 = findKeyword(statement, "is the best YouTuber", psnOf1 + 3);

    String restOfStatement = statement.substring(psnOf1 + 11, psnOf2).trim();
    return "Well, " + restOfStatement
      + " is good, but not as funny as Amythegreat!";
  }
