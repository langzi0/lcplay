...
/**
 * model.put('foo', 'bar') Given a linked list, remove the nth node from the end of list and return
 * its head.
 *
 * For example,
 *
...
public class RemoveNthNodeFromEndofList_ex extends InvokableBase {
